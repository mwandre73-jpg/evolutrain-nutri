        ...
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-white sm:text-4xl">
                    Gestão de <span className="text-gradient">Pacientes</span>
                </h1>
                <p className="text-zinc-600 dark:text-zinc-400">
                    Acompanhamento nutricional completo dos seus atletas.
                </p>
            </div>
            ...
            <div className="flex h-96 items-center justify-center rounded-2xl border-2 border-dashed border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-zinc-500">Estamos preparando uma gestão de pacientes incrível para você.</p>
                </div>
            </div>
        </div>
    );
